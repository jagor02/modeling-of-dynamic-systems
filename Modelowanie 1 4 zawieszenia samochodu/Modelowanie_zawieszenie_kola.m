...
sys = ss(A, B, C, D, 'InputName', 'droga', 'StateName', {'pozycja koła', 'pozycja karoserii', ...
    'prędkość koła', 'prędkość karoserii'}, 'OutputName', {'pozycja koła', 'pozycja karoserii', 'prędkość koła', 'prędkość karoserii'});
